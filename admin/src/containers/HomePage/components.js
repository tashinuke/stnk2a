...
const Block = styled.div`
  ...
  // box-shadow: 0 2px 4px 0 ${props => props.theme.stnk.color.border};
  ...
  #mainHeader {
    &:after {
      ...
      margin-top: 7px;
      display: block;
      background: ${props => props.theme.stnk.color.error};
    }
  }
...
const ALink = styled.a`
  ...
  height: 34px;
  padding-right: 20px;
  border-radius: ${props => props.theme.stnk.radius.micro};
  text-overflow: ellipsis;
  color: ${props => props.theme.stnk.color.text} !important;
  overflow: hidden;
  line-height: 34px;
  font-size: 13px;
  background-color: ${props => props.theme.stnk.color.primary} !important;
